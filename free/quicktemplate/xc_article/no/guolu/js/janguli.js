...
var Anguli = {
	...
	cssFont: function() {
		...
		basket.require({ url: './source/modules/quicktemplate/quickshare3/guolu/css/zzgf.css', key: 'zzgf', unique: 0.3,  execute: false }).then(function(responses) {
	...
	fullScreen: function() {
		...
		if (!!document.createElement("canvas").getContext && !Util.touchDevice()) {
			var self, img, bg;
